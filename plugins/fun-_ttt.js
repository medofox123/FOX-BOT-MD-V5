...
*┈┈┈┈┈┈┈┈┈*
     ...
     ${arr.slice(6).join('')}
*┈┈┈┈┈┈┈┈┈*
${isWin ? `@${(isSurrender ? room.game.currentTurn : room.game.winner).split('@')[0]} 😎🏆 *الــــف مـــبروك*\n\n*جــــــايـزتـك هــــيـا*\n\n💎 *${dia2} جــواهـࢪ*\n🪙 *${tok2} جــيـنـيهات*\n💸 *${gata2} عــمــله*\n⚡ *${expp2} نــقاط خــبࢪه*` : isTie ? `*تــعـادل* 🤨\n*فـي الــــــتعادل كـــلو بـيـكسـب*\n\n💎 *${dia} جوهره*\n🪙 *${tok} جنيهات*\n💸 *${gata} عمله*\n⚡ *${expp} نقاط خبره*` : `🪄 *اللي هـيـلـعب* @${room.game.currentTurn.split('@')[0]}`}
`.trim()
