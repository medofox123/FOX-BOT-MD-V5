...
if (!text) return m.reply(`*غــلـط كـدا*\n‏ ┈─── • ◞☆◜ • ───┈ ⋅\n\n*لـزم تـعمل غـــࢪفه للـعب وتختار اعضاء ينضمو ليها*‏\n\n ┈─── • ◞☆◜ • ───┈ ⋅\n\nمـــثـال\n*${usedPrefix + command} روم لعب*`) 
let room = Object.values(conn.game).find(room => room.state === 'WAITING' && (text ? room.name === text : true)) 
if (room) {
await conn.reply(m.chat, `*تــــم بـــدء الـــــــجولـه جـديـده*\n\n*اسـم الــغـࢪفـــه*\n\n*${text}*\n\n*كــــلـها ثـواني وهنـشوف مــين هـيـكسـب*👻`, fkontak, m)

await conn.reply(m.chat, `‏ ┈─── • ◞☆◜ • ───┈\n\n*طــࢪيـــقـه الـلـعـب*\n\n*فــــي واحــــد هيـبقا ❌ وواحـد هـيـبـقا*⭕\n‏ ┈─── • ◞☆◜ • ───┈ ⋅\n    *هـــيبـقا قـدامك ارض اللـعبه عـلي شــــــكل اࢪقام من 1ل9 انـــت هتــــخـتار الــࢪقم اللـي عاوز تــعـلم مكـانه*\n\n‏ ┈─── • ◞☆◜ • ───┈`, fkontak, m)
...
let str = `*بــــــدأت الـمـباࢪاه*
🫂 *نـــــــࢪيـد منـافـسه شــࢪيـفه*
*┈┈┈┈┈┈┈┈┈*
...
conn.sendMessage(m.chat, { image: { url: imgplay }, caption: `*تــــــم بـــدء الـلـعبـه*\n❃━═✦•〘🎪〙•✦═━❃\n\n   *نـحن نـنتظࢪ الـعـضو الاخـر لــينضم للـعـبه*\n    للإنضمام اكـــتـب 
